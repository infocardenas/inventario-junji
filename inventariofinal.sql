...
('8101001-3', 'PEQUENA PEWEN', 'ENCARGADA/O', 'junji8101001@junji.cl', 8101001),
('8101002-1', 'CARACOLITO', 'ENCARGADA/O', 'junji8101002@junji.cl', 8101002),
('8101003-K', 'NINOS EN ACCION', 'ENCARGADA/O', 'junji8101003@junji.cl', 8101003),
('8101005-6', 'PETER PAN', 'ENCARGADA/O', 'junji8101005@junji.cl', 8101005),
('8101006-4', 'COSTANERA SUR', 'ENCARGADA/O', 'junji8101006@junji.cl', 8101006),
('8101031-5', 'VILLA CAP', 'ENCARGADA/O', 'junji8101031@junji.cl', 8101031),
('8101032-3', 'UBB COLLAO ENTRE VALLES', 'ENCARGADA/O', 'junji8101032@junji.cl', 8101032),
('8101033-1', 'MAGALLANES', 'ENCARGADA/O', 'junji8101033@junji.cl', 8101033),
('8101041-2', 'LOS CISNES', 'ENCARGADA/O', 'junji8101041@junji.cl', 8101041),
('8101042-0', 'LO GALINDO', 'ENCARGADA/O', 'junji8101042@junji.cl', 8101042),
('8101044-7', 'HIJOS DE LA TIERRA', 'ENCARGADA/O', 'junji8101044@junji.cl', 8101044),
('8102001-9', 'BERTA', 'ENCARGADA/O', 'junji8102001@junji.cl', 8102001),
('8102046-9', 'PEUMAYEN', 'ENCARGADA/O', 'junji8102046@junji.cl', 8102046),
('8102050-7', 'LIHUEN', 'ENCARGADA/O', 'junji8102050@junji.cl', 8102050),
('8102051-5', 'SUENOS DE ESPERANZA DE GABRIELA MISTRAL', 'ENCARGADA/O', 'junji8102051@junji.cl', 8102051),
('8103001-4', 'CHIGUAY', 'ENCARGADA/O', 'junji8103001@junji.cl', 8103001),
('8103002-2', 'LA LEONERA', 'ENCARGADA/O', 'junji8103002@junji.cl', 8103002),
('8103003-0', 'HEROES DEL SOL', 'ENCARGADA/O', 'junji8103003@junji.cl', 8103003),
('8103009-K', 'FUTURA ESPERANZA', 'ENCARGADA/O', 'junji8103009@junji.cl', 8103009),
('8106001-0', 'CALERO SUR', 'ENCARGADA/O', 'junji8106001@junji.cl', 8106001),
('8106002-9', 'BALDOMERO LILLO', 'ENCARGADA/O', 'junji8106002@junji.cl', 8106002),
('8106003-7', 'MATIAS COUSINO', 'ENCARGADA/O', 'junji8106003@junji.cl', 8106003),
('8106004-5', 'LAS ABEJITAS', 'ENCARGADA/O', 'junji8106004@junji.cl', 8106004),
('8107001-6', 'LORD COCHRANE', 'ENCARGADA/O', 'junji8107001@junji.cl', 8107001),
('8107002-4', 'MI MUNDO DE DULZURA', 'ENCARGADA/O', 'junji8107002@junji.cl', 8107002),
('8107021-0', 'PEQUENOS CONQUISTADORES', 'ENCARGADA/O', 'junji8107021@junji.cl', 8107021),
('8107022-9', 'TESOROS DEL MAR', 'ENCARGADA/O', 'junji8107022@junji.cl', 8107022),
('8108001-1', 'NUESTRA SENORA DE LAS NIEVES', 'ENCARGADA/O', 'junji8108001@junji.cl', 8108001),
('8108015-1', 'ESPUMA DE MAR', 'ENCARGADA/O', 'junji8108015@junji.cl', 8108015),
('8108025-9', 'NINOS DEL MAR', 'ENCARGADA/O', 'junji8108025@junji.cl', 88108025),
('8110005-5', 'LA GLORIA', 'ENCARGADA/O', 'junji8110005@junji.cl', 8110005),
('8110006-3', 'PATRICIO LYNCH', 'ENCARGADA/O', 'junji8110006@junji.cl', 8110006),
('8110032-2', 'CRUZ DEL SUR', 'ENCARGADA/O', 'junji8110032@junji.cl', 8110032),
('8111001-8', 'BRISAS DEL MAR', 'ENCARGADA/O', 'junji8111001@junji.cl', 8111001),
('8111028-K', 'RAFAEL', 'ENCARGADA/O', 'junji8111028@junji.cl', 8111028),
('8111029-8', 'LOS BLOQUES', 'ENCARGADA/O', 'junji8111029@junji.cl', 8111029),
('8112001-3', 'ALONDRA', 'ENCARGADA/O', 'junji8112001@junji.cl', 8112001),
('8112002-1', 'CABO AROCA', 'ENCARGADA/O', 'junji8112002@junji.cl', 8112002),
('8112003-K', 'MIYALI', 'ENCARGADA/O', 'junji8112003@junji.cl', 8112003),
('8112004-8', 'WALT DISNEY', 'ENCARGADA/O', 'junji8112004@junji.cl', 8112004),
('8112005-6', 'BARQUITO DE ILUSIONES', 'ENCARGADA/O', 'junji8112005@junji.cl', 8112005),
('8112006-4', 'PASO A PASITO', 'ENCARGADA/O', 'junji8112006@junji.cl', 8112006),
('8112007-2', 'RENE SCHNEIDER', 'ENCARGADA/O', 'junji8112007@junji.cl', 8112007),
('8112008-0', 'BOTECITO DE LENGA', 'ENCARGADA/O', 'junji8112008@junji.cl', 8112008),
('8112016-1', 'SONRISAS DE COLORES RECONQUISTA', 'ENCARGADA/O', 'junji8112016@junji.cl', 8112016),
('8201001-7', 'BOCA LEBU', 'ENCARGADA/O', 'junji8201001@junji.cl', 8201001),
('8201002-5', 'EL PUENTE', 'ENCARGADA/O', 'junji8201002@junji.cl', 8201002),
('8201018-1', 'PESCADORES DE SUENOS', 'ENCARGADA/O', 'junji8201018@junji.cl', 8201018),
('8201019-K', 'MAR DE ESPERANZA', 'ENCARGADA/O', 'junji8201019@junji.cl', 8201019),
('8202012-8', 'FLORECER DEL BOSQUE', 'ENCARGADA/O', 'junji8202012@junji.cl', 8202012),
('8202021-7', 'TIERRA DE NINOS FELICES', 'ENCARGADA/O', 'junji8202021@junji.cl', 8202021),
('8202033-0', 'GIRASOLES DE CARAMPANGUE', 'ENCARGADA/O', 'junji8202033@junji.cl', 8202033),
('8202044-6', 'TRAWUN ANTU', 'ENCARGADA/O', 'junji8202044@junji.cl', 8202044),
('8203006-9', 'ENCANTOS DE SAYEN', 'ENCARGADA/O', 'junji8203006@junji.cl', 8203006),
('8203029-8', 'SOL NACIENTE', 'ENCARGADA/O', 'junji8203029@junji.cl', 8203029),
('8203030-1', 'ANTU RAYEN', 'ENCARGADA/O', 'junji8203030@junji.cl', 8203030),
('8205001-9', 'GOTITAS DE AMOR', 'ENCARGADA/O', 'junji8205001@junji.cl', 8205001),
('8205002-7', 'GABRIELA MISTRAL', 'ENCARGADA/O', 'junji8205002@junji.cl', 8205002),
('8205026-4', 'PINTANDO SONRISAS', 'ENCARGADA/O', 'junji8205026@junji.cl', 8205026),
('8206038-3', 'LIWEN PU PICHIKECHE AYINCO', 'ENCARGADA/O', 'junji8206038@junji.cl', 8206038),
('8206040-5', 'GOLONDRINAS', 'ENCARGADA/O', 'junji8206040@junji.cl', 8206040),
('8301001-0', 'KENNEDY', 'ENCARGADA/O', 'junji8301001@junji.cl', 8301001),
('8301002-9', 'SALA CUNA RENACER', 'ENCARGADA/O', 'junji8301002@junji.cl', 8301002),
('8301003-7', '21 DE MAYO', 'ENCARGADA/O', 'junji8301003@junji.cl', 8301003),
('8301004-5', 'PRINCIPITO', 'ENCARGADA/O', 'junji8301004@junji.cl', 8301004),
('8301029-0', 'P HISTORIADORES', 'ENCARGADA/O', 'junji8301029@junji.cl', 8301029),
('8301032-0', 'ISLA DE LOS TESOROS', 'ENCARGADA/O', 'junji8301032@junji.cl', 8301032),
('8301048-7', 'HUELLAS DE AMOR', 'ENCARGADA/O', 'junji8301048@junji.cl', 8301048),
('8301052-5', 'KETRAWE', 'ENCARGADA/O', 'junji8301052@junji.cl', 8301052),
('8301053-3', 'TREN DE MIS SUENOS', 'ENCARGADA/O', 'junji8301053@junji.cl', 8301053),
('8301059-2', 'BROTES DE CHACAY', 'ENCARGADA/O', 'junji8301059@junji.cl', 8301059),
('8304001-7', 'MI PEQUENO MUNDO', 'ENCARGADA/O', 'junji8304001@junji.cl', 8304001),
('8304002-5', 'RENACER DE CAPPONI', 'ENCARGADA/O', 'junji8304002@junji.cl', 8304002),
('8305022-5', 'LELIANTU', 'ENCARGADA/O', 'junji8305022@junji.cl', 8305022),
('8306011-5', 'ELUNEY', 'ENCARGADA/O', 'junji8306011@junji.cl', 8306011),
('8307001-3', 'TRENCITO DE COIGUE', 'ENCARGADA/O', 'junji8307001@junji.cl', 8307001),
('8311001-5', 'ABEJITAS', 'ENCARGADA/O', 'junji8311001@junji.cl', 8311001),
('8312008-8', 'HERENCIA DE HUEPIL', 'ENCARGADA/O', 'junji8312008@junji.cl', 8312008),
('8101010-2', 'LOS DUENDECITOS TRAVIESOS', 'ENCARGADA/O', 'junji8101010@junji.cl', 8101010),
('8101016-1', 'RAYITO DE SOL KM 10', 'ENCARGADA/O', 'junji8101016@junji.cl', 8101016),
('8106011-8', 'PELUSITA', 'ENCARGADA/O', 'junji8106011@junji.cl', 8106011),
('8107003-2', 'LAS CUNCUNITAS', 'ENCARGADA/O', 'junji8107003@junji.cl', 8107003),
('8107004-0', 'MANITOS PINTADAS', 'ENCARGADA/O', 'junji8107004@junji.cl', 8107004),
('8107005-9', 'CAMINITO DE COLORES', 'ENCARGADA/O', 'junji8107005@junji.cl', 8107005),
('8107006-7', 'FLORCITA SILVESTRE', 'ENCARGADA/O', 'junji8107006@junji.cl', 8107006),
('8108003-8', 'LAS MANITOS', 'ENCARGADA/O', 'junji8108003@junji.cl', 8108003),
('8108004-6', 'PEDACITO DE CIELO', 'ENCARGADA/O', 'junji8108004@junji.cl', 8108004),
('8108005-4', 'LOS CARINOSITOS', 'ENCARGADA/O', 'junji8108005@junji.cl', 8108005),
('8110014-4', 'LUCERITO', 'ENCARGADA/O', 'junji8110014@junji.cl', 8110014),
('8110017-9', 'SANSANITO', 'ENCARGADA/O', 'junji8110017@junji.cl', 8110017),
('8110023-3', 'ARCOIRIS DE AMOR', 'ENCARGADA/O', 'junji8110023@junji.cl', 8110023),
('8111007-7', 'MI PEQUENO MUNDO', 'ENCARGADA/O', 'junji8111007@junji.cl', 8111007),
('8111010-7', 'HOJITAS DE PARRA', 'ENCARGADA/O', 'junji8111010@junji.cl', 8111010),
('8111013-1', 'GOTITAS DE AMOR', 'ENCARGADA/O', 'junji8111013@junji.cl', 8111013),
('8202003-9', 'ESTRELLITA DE MAR', 'ENCARGADA/O', 'junji8202003@junji.cl', 8202003),
('8204001-3', 'LOS CARINOSITOS', 'ENCARGADA/O', 'junji8204001@junji.cl', 8204001),
('8205007-8', 'LAS ARDILLITAS', 'ENCARGADA/O', 'junji8205007@junji.cl', 8205007),
('8205025-6', 'LA FAMILIA', 'ENCARGADA/O', 'junji8205025@junji.cl', 8205025),
('8207001-K', 'CAU CURA', 'ENCARGADA/O', 'junji8207001@junji.cl', 8207001),
('8301007-K', 'CARINOSITOS', 'ENCARGADA/O', 'junji8301007@junji.cl', 8301007),
('8301010-K', 'CASITA DE MIS SUENOS', 'ENCARGADA/O', 'junji8301010@junji.cl', 8301010),
('8301012-6', 'EL HORIZONTE', 'ENCARGADA/O', 'junji8301012@junji.cl', 8301012),
('8303001-1', 'NUBELUZ', 'ENCARGADA/O', 'junji8303001@junji.cl', 8303001),
('8311008-2', 'LAS CAMPANITAS RINCONADA', 'ENCARGADA/O', 'junji8311008@junji.cl', 8311008),
('8314003-8', 'RALCO LEPOY', 'ENCARGADA/O', 'junji8314003@junji.cl', 8314003),
('8102043-4', 'GOTITA DE FE', 'ENCARGADA/O', 'junji8102043@junji.cl', 8102043),
('8104012-5', 'GRANERILLOS RAYITO DE LUZ', 'ENCARGADA/O', 'junji8104012@junji.cl', 8104012),
('8104017-6', 'SEMBRADORES DE LUZ', 'ENCARGADA/O', 'junji8104017@junji.cl', 8104017),
('8105007-4', 'CONSTRUYENDO FUTURO', 'ENCARGADA/O', 'junji8105007@junji.cl', 8105007),
('8108018-6', 'MIS PRIMEROS PASOS', 'ENCARGADA/O', 'junji8108018@junji.cl', 8108018),
('8110040-3', 'ESTRELLITAS DE MAR', 'ENCARGADA/O', 'junji8110040@junji.cl', 8110040),
('8110043-8', 'SONRISAS DE NINOS I', 'ENCARGADA/O', 'junji8110043@junji.cl', 8110043),
('8110045-4', 'LUZ DE ESPERANZA', 'ENCARGADA/O', 'junji8110045@junji.cl', 8110045),
('8110049-7', 'SONRISAS DE NINOS II', 'ENCARGADA/O', 'junji8110049@junji.cl', 8110049),
('8301047-9', 'PASITO SEGURO', 'ENCARGADA/O', 'junji8301047@junji.cl', 8301047),
('8301050-9', 'PATA DE GALLINA', 'ENCARGADA/O', 'junji8301050@junji.cl', 8301050),
('8301057-6', 'LA PERLITA', 'ENCARGADA/O', 'junji8301057@junji.cl', 8301057),
('8314029-1', 'KUPULWE', 'ENCARGADA/O', 'junji8314029@junji.cl', 8314029),
('8314040-2', 'EL BARCO', 'ENCARGADA/O', 'junji8314040@junji.cl', 8314040),
('8203007-7', 'JUGANDO CANTANDO', 'ENCARGADA/O', 'junji8203007@junji.cl', 8203007),
('8203020-4', 'RELMU RAYEN', 'ENCARGADA/O', 'junji8203020@junji.cl', 8203020),
('8203022-0', 'SEMILLITAS TRANGUILBORO', 'ENCARGADA/O', 'junji8203022@junji.cl', 8203022),
('8205014-0', 'LOS NINOS SON FELICES', 'ENCARGADA/O', 'junji8205014@junji.cl', 8205014),
('8206032-4', 'LOS PITUFOS LOS RIOS', 'ENCARGADA/O', 'junji8206032@junji.cl', 8206032),
('8206033-2', 'LOS CARINOSITOS', 'ENCARGADA/O', 'junji8206033@junji.cl', 8206033),
('8207024-9', 'PEHUMAHUE TIRUA', 'ENCARGADA/O', 'junji8207024@junji.cl', 8207024),
('8207028-1', 'PEWMA PICHIKECHE', 'ENCARGADA/O', 'junji8207028@junji.cl', 8207028),
('8207029-K', 'WEFACHANTU PICHICHE', 'ENCARGADA/O', 'junji8207029@junji.cl', 8207029),
('8105014-7', 'TALCAMAVIDA RAYENCURA', 'ENCARGADA/O', 'junji8105014@junji.cl', 8105014),
('8111025-5', 'LOS PECESITOS', 'ENCARGADA/O', 'junji8111025@junji.cl', 8111025),
('8301045-2', 'FUERTECITO', 'ENCARGADA/O', 'junji8301045@junji.cl', 8301045),
('8301046-0', 'PEQUENOS SONADORES', 'ENCARGADA/O', 'junji8301046@junji.cl', 8301046),
('8307007-2', 'SEMILLITA DE RIHUE', 'ENCARGADA/O', 'junji8307007@junji.cl', 8307007),
('8202031-4', 'FELIPE CUBILLOS SIGALL', 'ENCARGADA/O', 'junji8202031@junji.cl', 8202031),
('8202032-2', 'MELIRUPO', 'ENCARGADA/O', 'junji8202032@junji.cl', 8202032),
('8203012-3', 'LELBUN ALIWEN', 'ENCARGADA/O', 'junji8203012@junji.cl', 8203012),
('8203013-1', 'LELUNEY', 'ENCARGADA/O', 'junji8203013@junji.cl', 8203013),
('8205019-1', 'RAYITO DE SOL', 'ENCARGADA/O', 'junji8205019@junji.cl', 8205019);
